...
start paddlespeech_server start --config_file ./conf/application.yaml > log/server_offline.log 2>&1
call :timeoutFun 240
...
rem  http
start paddlespeech_server start --config_file ./conf/tts_online_application.yaml > log/server_tts_online_http.log 2>&1
call :timeoutFun 90
...
start paddlespeech_server start --config_file ./conf/tts_online_application.yaml > log/server_tts_online_websocket.log  2>&1
call :timeoutFun 90
...
start paddlespeech_server start --config_file ./conf/ws_conformer_wenetspeech_application.yaml  > log/asr_online_websockert.log 2>&1
call :timeoutFun 60
