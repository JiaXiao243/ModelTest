...
start paddlespeech_server start --config_file ./conf/application.yaml >> %log_path%\server.log 2>&1 &&pause
call :timeoutFun 120
...
rem  http
start paddlespeech_server start --config_file ./conf/tts_online_application.yaml >> %log_path%\server.log 2>&1 &&pause
call :timeoutFun 30
...
start paddlespeech_server start --config_file ./conf/ws_conformer_wenetspeech_application.yaml >> %log_path%\server.log 2>&1  &&pause
call :timeoutFun 30
