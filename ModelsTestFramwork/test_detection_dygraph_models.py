...
from ModelsTestFramework import TestDetectionDygraphModel
...
def setup_module():
    ...
    RepoDataset(cmd='''cd PaddleDetection/ssd2/ce_data/PaddleDetectionset;  
...
def test_faster_rcnn_r50_1x_coco():
    ...
    """
    model = TestDetectionDygraphModel(model='faster_rcnn_r50_1x_coco', yaml='configs/faster_rcnn/faster_rcnn_r50_1x_coco.yml')
...
def test_faster_rcnn_r50_fpn_1x_coco():
    ...
    """
    model = TestDetectionDygraphModel(model='faster_rcnn_r50_fpn_1x_coco', yaml='configs/faster_rcnn/faster_rcnn_r50_fpn_1x_coco.yml')
    model.test_detection_train()
...
def test_mask_rcnn_r50_fpn_1x_coco():
    ...
    """
    model = TestDetectionDygraphModel(model='mask_rcnn_r50_fpn_1x_coco', yaml='configs/mask_rcnn/mask_rcnn_r50_fpn_1x_coco.yml')
    model.test_detection_train()
...
def test_cascade_rcnn_r50_fpn_1x_coco():
    ...
    """
    model = TestDetectionDygraphModel(model='cascade_rcnn_r50_fpn_1x_coco', yaml='configs/cascade_rcnn/cascade_rcnn_r50_fpn_1x_coco.yml')
    model.test_detection_train()
...
def test_yolov3_darknet53_270e_coco():
    ...
    """
    model = TestDetectionDygraphModel(model='yolov3_darknet53_270e_coco', yaml='configs/yolov3/yolov3_darknet53_270e_coco.yml')
    model.test_detection_train()
...
def test_fcos_dcn_r50_fpn_1x_coco():
    ...
    """
    model = TestDetectionDygraphModel(model='fcos_dcn_r50_fpn_1x_coco', yaml='configs/fcos/fcos_dcn_r50_fpn_1x_coco.yml')
    model.test_detection_train()
...
def test_ttfnet_darknet53_1x_coco():
    ...
    """
    model = TestDetectionDygraphModel(model='ttfnet_darknet53_1x_coco', yaml='configs/ttfnet/ttfnet_darknet53_1x_coco.yml')
    model.test_detection_train()
