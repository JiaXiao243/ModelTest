...
from ModelsTestFramework import TestClassModel
...
def setup_module():
    ...
    RepoDataset(cmd='rm -rf /root/.visualdl/conf; cd PaddleClas/dataset; rm -rf ILSVRC2012; ln -s /ssd2/ce_data/PaddleClas/ILSVRC2012 ILSVRC2012; rm -rf flowers102; ln -s /ssd2/ce_data/PaddleClas/flowers102 flowers102; cd ..')
