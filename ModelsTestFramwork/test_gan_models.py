...
from ModelsTestFramework import TestGanModel
...
from ModelsTestFramework import CustomInstruction
...
def setup_module():
    ...
    RepoDataset(cmd='''cd PaddleGAN; 
                       cd data;
                       rm -rf DIV2K;
                       ln -s /ssd2/ce_data/PaddleGAN/DIV2K DIV2K;
                       rm -rf REDS;
                       ln -s /ssd2/ce_data/PaddleGAN/REDS REDS;
                       ln -s /ssd2/ce_data/PaddleGAN/cityscapes_gan cityscapes;
                       ln -s /ssd2/ce_data/PaddleGAN/horse2zebra horse2zebra;
                       cd ..;
                       ln -s /ssd2/ce_data/PaddleGAN/gan_model gan_model;
